...
//--------------------------------------------------------------------------------------
HRESULT WINAPI DXUTCreateWindow( const WCHAR* strWindowTitle /*= L"Direct3D Window"*/, bool allowWindowResize /*= true*/, HINSTANCE hInstance /*= NULL*/, HICON hIcon /*= NULL*/, HMENU hMenu /*= NULL*/, int x /*= CW_USEDEFAULT*/, int y /*= CW_USEDEFAULT*/ )
{
    HRESULT hr;
...
//        return;
//
//	bool alwayRenderNoPause = true;
//
//	if (!alwayRenderNoPause) {
...
void DXUTRender3DEnvironment11()
{
	...
	if( !GetDXUTState().GetRenderingPaused() )
	{
		...
		{
			pCallbackFrameRender( pd3dDevice, pd3dImmediateContext, fTime, fElapsedTime,
				GetDXUTState().GetD3D11FrameRenderFuncUserContext() );										//Rendering !!!!
